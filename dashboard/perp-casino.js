/* PERP: desglose de casino por proveedor/juego.
   Lee ./data/perp-casino.json (generado por importar-perp-casino.py a
   partir de exports del backoffice). Sin dependencias: barras div + tabla,
   mismo estilo del panel. */
(function () {
  'use strict';
