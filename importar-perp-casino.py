...
extraccion-perp-casino.py hace scraping en vivo del backoffice, pero
todavia no se conoce la ruta real de la pantalla PERP (PERP_PATH sigue
siendo un placeholder). Mientras tanto, este script parte de un CSV ya
exportado a mano desde headoffice.novusbet.com (Transacciones -> exportar,
el mismo formato que descarga extraccionDatos.py: columnas "Created At",
"Transaction Type", "causal", "Product", etc.), lo agrupa por proveedor de
casino y ACUMULA el resultado en dashboard/data/perp-casino.json.
